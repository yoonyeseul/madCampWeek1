...
//            view.setClickable(true);
        ...
        public void setCheckboxStyle() {
            System.out.println("setCheckboxStyle() 호출");

            if (todoCheck.isChecked()) {
                todoCheck.setPaintFlags(todoCheck.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
                todoCheck.setTypeface(null, Typeface.ITALIC);

                Drawable buttonDrawable = todoCheck.getBackground();
                ...
                todoCheck.setPaintFlags(todoCheck.getPaintFlags() & (~ Paint.STRIKE_THRU_TEXT_FLAG));
                todoCheck.setTypeface(null, Typeface.NORMAL);
